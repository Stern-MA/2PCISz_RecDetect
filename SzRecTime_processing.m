%DDO/DIO MASTER PROCESSING SCRIPT
%
%
...
%% Individual seizure recruitment detection (Version 2)

% RecTimeG_sz2_struct=IndivRecTimes2IP(Fc1Gdff_flt2,MeanSzRecTimeG,fs_2p,mean(std(Fc1Gdff_flt2))*20);
% RecTimeG_sz2=RecTimeG_sz2_struct.time;
% [RecTimeGsortReG2,RecTimeGReG_I2]=sort(RecTimeG_sz2); %sorts cells by rec times according to green
% RecTimeR_sz2_struct=IndivRecTimes2IP(Fc1Rdff_flt2,MeanSzRecTimeR,fs_2p,mean(std(Fc1Rdff_flt2))*20);
% RecTimeR_sz2=RecTimeR_sz2_struct.time;
% [RecTimeRsortReR2,RecTimeRReR_I2]=sort(RecTimeR_sz2); %sorts cells by rec times according to red
